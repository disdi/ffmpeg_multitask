...
static int loop_output = 0;//AVFMT_NOOUTPUTLOOP;
...
#if 0
        if (!video_enc->rc_initial_error: return type is an incomplete type
src/libffmpeg.c: In function ‘find_codec_or_die’:buffer_occupancy)
#endif 
...
#if 0
    if (oc->oformat->flags & AVFMT_error: return type is an incomplete type
src/libffmpeg.c: In function ‘find_codec_or_die’:GLOBALHEADER) {
